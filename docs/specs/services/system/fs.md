...
Generate a [FSID](../../filesystem.md#filesystem-unique-identifier) for a [filesystem driver service](../drivers/filesystem.md).

**Arguments:**

- [UDI](hw.md#unique-device-identifier) (8 bytes)
...
- `0x30`: The client is not a [filesystem driver services](../drivers/filesystem.md)
- `0x31`: The provided UDI does not exist
- `0x32`: The provided UDI does not correspond to a storage device

### `0xD1` FREE_FSID

Remove a [FSID](../../filesystem.md#filesystem-unique-identifier) previously generated by the [`REQUEST_FSID`](#0xd0-request_fsid) method.
...
- `0x31`: The provided UDI does not exist
- `0x32`: The provided UDI does not correspond to a storage device
- `0x33`: The provided FSID does not match the provided UDI
- `0x34`: The provided FSID was not generated by the client
